 ...
 *</ul>
 */
public class PosChunkAnalysisBasedWordSample extends AbstractChunkAnalysisSample {
	 ...
	 */
	public PosChunkAnalysisBasedWordSample(String[] words, String[] posChunks) {
	 ...
	 * @param posChunks	词语对应词性和组块标记数组
	 */
	public PosChunkAnalysisBasedWordSample(List<String> words, List<String> posChunks) {
		super(words, posChunks, null);
	}
