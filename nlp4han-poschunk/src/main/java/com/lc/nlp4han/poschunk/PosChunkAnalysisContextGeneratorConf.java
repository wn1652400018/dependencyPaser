 ...
 *</ul>
 */
public class PosChunkAnalysisContextGeneratorConf implements ChunkAnalysisContextGenerator {
	 ...
	 * @throws IOException
	 */
	public PosChunkAnalysisContextGeneratorConf() throws IOException {
		Properties featureConf = new Properties();
        InputStream featureStream = PosChunkAnalysisContextGeneratorConf.class.getClassLoader().getResourceAsStream("com/lc/nlp4han/chunk/feature.properties");
	 ...
	 */
	public PosChunkAnalysisContextGeneratorConf(Properties properties){
        init(properties);
	}
