...
public class DependencyParseEvaluatorNoNull extends Evaluator<DependencySample>
{
	...
	protected DependencySample processSample(DependencySample sample)
	{
		...
		// 最大的K棵树
		// DependencyParsingBestProba p =
		// tagger.tagK(3,wordsRef,posRef,sample.getAditionalContext());
		...
		DependencySample samplePre = new DependencySample(wordsRef, posRef, dependencyPre, dependencyWordsPre,
				dependencyIndicesPre);
