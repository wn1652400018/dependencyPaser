		...
		else if (words.length > 1)
		{
			...
			else if (i - 1 >= 0 && i < words.length - 1)
			{
				if (out.equals("o") || out.equals("b_nr") || out.equals("b_nt") || out.equals("b_ns")
						|| out.equals("b_nz") || out.equals("s_nr") || out.equals("s_nt") || out.equals("s_ns")
						|| out.equals("s_nz"))
				{
					if (tags[i - 1].equals("o") || tags[i - 1].equals("s_nt") || tags[i - 1].equals("s_nr")
							|| tags[i - 1].equals("s_ns") || tags[i - 1].equals("s_nz") || tags[i - 1].equals("e_nt")
							|| tags[i - 1].equals("e_nr") || tags[i - 1].equals("e_ns") || tags[i - 1].equals("e_nz"))
					{
						return true;
					}
				}
