...
public class CharPOSContextGeneratorConfComplex implements CharPOSContextGenerator {
	...
	private void init(Properties config) throws IOException {
		...
		// Bc_1w0Pc_1w0Set = (config.getProperty("feature.Bc_1w0Pc_1w0",
		// "true").equals("true"));
		// Bc_2w0Pc_2w0Bc_1w0Pc_1w0Set =
		// (config.getProperty("feature.Bc_2w0Pc_2w0Bc_1w0Pc_1w0",
		// "true").equals("true"));
	...
	public String toString() {
		return "WordSegPosContextGeneratorConf{" + "c_2Set=" + c_2Set + ", c_1Set=" + c_1Set + ", c0Set=" + c0Set
				+ ", c1Set=" + c1Set + ", c2Set=" + c2Set + ", c_2c_1Set=" + c_2c_1Set + ", c_1c0Set=" + c_1c0Set
				+ ", c0c1Set=" + c0c1Set + ", c1c2Set=" + c1c2Set + ", c_1c1Set=" + c_1c1Set + ",w0c0Set=" + w0c0Set
				+ ",PuSet=" + PuSet + ",TSet=" + TSet + ", c0prefix=" + c0prefix + ",Pc_1w0Set=" + Pc_1w0Set
				+ ",Pc_2w0Pc_1w0Set=" + Pc_2w0Pc_1w0Set + ",Lt0Set=" + Lt0Set + ",c_1t0Set=" + c_1t0Set + ",c0t0Set="
				+ c0t0Set + ",c1t0Set=" + c1t0Set;
	}
