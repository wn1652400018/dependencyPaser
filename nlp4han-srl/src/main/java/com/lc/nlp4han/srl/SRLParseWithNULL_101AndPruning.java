 ...
 *
 */
public class SRLParseWithNULL_101AndPruning extends AbstractParseStrategy<HeadTreeNode>{
	 ...
	 * @param tree
	 */
	private void addInfoUp(HeadTreeNode tree, HashMap<Integer,SemanticRoleStructure> map, int verbindex) {
	 ...
	 */
	private void addInfoDown(HeadTreeNode tree, HashMap<Integer,SemanticRoleStructure> map, int verbindex){
		boolean flag = true;
