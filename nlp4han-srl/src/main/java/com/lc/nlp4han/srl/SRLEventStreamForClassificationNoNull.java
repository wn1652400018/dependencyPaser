 ...
 *
 */
public class SRLEventStreamForClassificationNoNull extends AbstractEventStream<SRLSample<HeadTreeNode>>{
	 ...
	 */
	public SRLEventStreamForClassificationNoNull(ObjectStream<SRLSample<HeadTreeNode>> samples, SRLContextGenerator generator) {
		super(samples);
