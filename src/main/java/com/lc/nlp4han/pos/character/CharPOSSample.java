...
public class CharPOSSample
{
     ...
     *            词性
     */
    public CharPOSSample(String[] characters, String[] tags, String[] words, String[] poses)
    {
     ...
     *            词性
     */
    public CharPOSSample(List<String> characters, List<String> tags, List<String> words, List<String> poses)
    {
        this(characters, tags, words, poses, null);
    }
     ...
     */
    public CharPOSSample(String[] characters, String[] tags, String[] words, String[] poses, String[][] additionalContext)
    {
     ...
     * @param additionalContext
     */
    public CharPOSSample(List<String> characters, List<String> tags, List<String> words, List<String> poses, String[][] additionalContext)
    {
