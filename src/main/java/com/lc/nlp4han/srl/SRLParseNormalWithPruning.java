 ...
 *
 */
public class SRLParseNormalWithPruning extends AbstractParseStrategy<HeadTreeNode>{
	 ...
	 * @param tree
	 */
	private void addInfoUp(HeadTreeNode tree, HashMap<Integer, SemanticRoleStructure> map) {
	 ...
	 * @param semanticRole 语义角色标注信息
	 */
	private void addInfoDown(HeadTreeNode tree, HashMap<Integer,SemanticRoleStructure> map){
		boolean flag = true;
