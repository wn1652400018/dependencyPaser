...
/**
 * 分步骤完成模型的训练【识别阶段不包含NULL标签】
 * @author 王馨苇
 *
 */
public class SRLTrainerForByStepNoNullTool {
    //parse指示文本解析的方式，共四种
	//normal  normalprune addnull addnullprune
	private static void usage(){
		System.out.println(SRLTrainerForByStepNoNullTool.class.getName()+"-data <corpusFile> -idenmodel <idenmodelFile> -clasmodel <clasmodelFile> -parse <parsetype> -type <algorithom>"
