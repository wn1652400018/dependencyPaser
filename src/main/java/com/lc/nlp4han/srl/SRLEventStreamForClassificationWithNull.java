 ...
 *
 */
public class SRLEventStreamForClassificationWithNull extends AbstractEventStream<SRLSample<HeadTreeNode>>{
	 ...
	 */
	public SRLEventStreamForClassificationWithNull(ObjectStream<SRLSample<HeadTreeNode>> samples, SRLContextGenerator generator, SRLMEForIdentification tagger) {
		super(samples);
