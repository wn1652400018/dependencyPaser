 ...
 *
 */
public class SRLCVForByStepNoNullTool {
    ...
    public SRLCVForByStepNoNullTool(String languageCode, TrainingParameters trainParam, SRLEvaluateMonitor... listeners){
    ...
    public void evaluate(ObjectStream<SRLSample<HeadTreeNode>> samples, AbstractParseStrategy<HeadTreeNode> parse, AbstractHeadGenerator ahg, int nFolds, SRLContextGenerator contextIden, SRLContextGenerator contextClas) throws IOException{
		...
		while(partitioner.hasNext()){
			...
			ModelWrapper modelClas = SRLMEForClassificationNoNull.train(languageCode, trainingSampleStream, params, contextClas);
    ...
    private static void usage(){
    	System.out.println(SRLCVForByStepNoNullTool.class.getName() + " -data <corpusFile> -parse <parsetype> -encoding <encoding> -type<algorithm>" + 
    ...
    public static void main(String[] args) throws IOException {
        ...
        SRLCVForByStepNoNullTool run = new SRLCVForByStepNoNullTool("zh", params);
