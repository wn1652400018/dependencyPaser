...
//	private DependencyParsingCount count;
	...
	public DependencyParseEvaluatorNoNull(DependencyParserME tagger){
		this.tagger = tagger;
	}
	/**
	 * 加载用于计算各种指标的类
...
//	}
	...
	protected DependencySample processSample(DependencySample sample) {
		...
		//最大生成树
		DependencyParseBestProba proba = tagger.tagNoNull(wordsRef, posRef, sample.getAditionalContext());
