 ...
 *
 */
public class DependencyParseBestProba {
	 ...
	 */
	public DependencyParseBestProba(String[] sentence, String[] pos, double[][] proba, String[][] dependecy){
	 ...
	 */
	public DependencyParseBestProba(String[] sentence, String[] pos, String[][] kprobas, String[][] kdependency){
		this.sentence = sentence;
